...
class TestKauppa(unittest.TestCase):
    def setUp(self):
        ...
        # palautetaan aina arvo 42Viitegeneraattori
    ...
    def test_ostoksen_paaytyttya_pankin_metodia_tilisiirto_kutsutaan(self):
        ...
        # alustetaan kauppavarasto_mock = Mock()
    ...
    def test_ostoksen_paaytyttya_pankin_metodia_tilisiirto_kutsutaan_2_eri_tuotteella(self):
    ...
    def test_ostoksen_paaytyttya_pankin_metodia_tilisiirto_kutsutaan_2_samalla_tuotteella(self):
    ...
    def test_ostoksen_paaytyttya_pankin_metodia_tilisiirto_kutsutaan_2_tuotteella_joista_toisessa_ei_saldoa(self):
    ...
    def test_antaa_eri_viitteet(self):
